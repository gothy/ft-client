...
(function() {
  var ApiError, FTClient, NetworkError, base_url, fileCopy, fileDelete, fileMove, fileRename, fileUpload, folderContent, folderCopy, folderCreate, folderDelete, folderInfo, folderMove, folderRename, protocol, token, trashcanContent, trashcanEmpty, trashcanRestore, userInfo, userLogin, _do_file_upload, _fldr_ops, _item_method_helper,
  ...
  _do_file_upload = function(params, upload_url, cb) {
    ...
    upload_progress = (function(_this) {
